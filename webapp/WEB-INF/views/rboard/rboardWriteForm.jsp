			...
			<div id="board">
				<div id="writeForm">
					<form action="${pageContext.request.contextPath}/rboard/write" method="get">
						...
						<c:choose>
							<c:when test="${rbVo != null}">
								<input type="hidden" name="groupNo" value="${rbVo.groupNo}">
								<input type="hidden" name="orderNo" value="${rbVo.orderNo}">
								<input type="hidden" name="depth" value="${rbVo.depth}">								
							</c:when>
							<c:otherwise>
